...
public:
    ...
    testUserinfo()
    {
        ...
        {
            auto a = parse_authority("x://@").value();
            BOOST_TEST(a.has_userinfo());
        ...
        {
            auto a = parse_authority("x://a%41:@").value();
            BOOST_TEST(a.has_userinfo());
        ...
        {
            auto a = parse_authority("x://:b%42@").value();
            BOOST_TEST(a.has_userinfo());
        ...
        {
            auto a = parse_authority("x://a:b@").value();
            BOOST_TEST(a.has_userinfo());
        ...
        {
            auto a = parse_authority("x://%3a:%3a@").value();
            BOOST_TEST(a.has_userinfo());
        ...
        {
            auto a = parse_authority("x://%2525@").value();
            BOOST_TEST(a.has_userinfo());

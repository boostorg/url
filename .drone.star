...
def main(ctx):
  ...
  linux_cxx("B2_TOOLSET=clang-11 B2_CXXSTD=11,14,17", "clang++-11", packages="clang-11 libstdc++-9-dev", llvm_os="focal", llvm_ver="11", buildscript="drone", buildtype="boost", image="cppalliance/droneubuntu2004:1", environment={'B2_TOOLSET': 'clang-11', 'B2_CXXSTD': '11,14,17', 'DRONE_JOB_UUID': '472b07b9fe'}, globalenv=globalenv),
